...
import com.internshala.foodrunner.adapter.DashboardFragmentAdapter
import com.internshala.foodrunner.fragment.*
import com.internshala.foodrunner.utils.ConnectionManager
import com.google.android.material.navigation.NavigationView
import com.internshala.foodrunner.fragment.FavouriteRestaurantFragment
...
class Dashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigationView.setNavigationItemSelectedListener {
            ...
            it.isCheckable = true//if not the first time set the current to checked
            it.isChecked = true
